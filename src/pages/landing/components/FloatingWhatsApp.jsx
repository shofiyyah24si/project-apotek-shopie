/**
 * FloatingWhatsApp — Tombol melayang konsultasi WhatsApp
...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] hover:bg-[#20b558] text-white rounded-full flex items-center justify-center shadow-2xl shadow-green-500/30 transition-transform hover:scale-110"
    >
      {/* Icon WhatsApp SVG */}
